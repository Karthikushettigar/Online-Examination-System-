...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($questionsResult->num_rows > 0) {
        ...
        while ($row = $questionsResult->fetch_assoc()) {
            ...
            echo "<strong>Option1:</strong> <input type='radio' name='answer[" . $row['Question'] . "]' value='" . $row['Option1'] . "'>" . $row['Option1'] . "<br>";
            echo "<strong>Option2:</strong> <input type='radio' name='answer[" . $row['Question'] . "]' value='" . $row['Option2'] . "'>" . $row['Option2'] . "<br>";
            echo "<strong>Option3:</strong> <input type='radio' name='answer[" . $row['Question'] . "]' value='" . $row['Option3'] . "'>" . $row['Option3'] . "<br>";
            echo "<strong>Option4:</strong> <input type='radio' name='answer[" . $row['Question'] . "]' value='" . $row['Option4'] . "'>" . $row['Option4'] . "<br>";
        ...
        if (isset($_SESSION['username'])) {
            ...
            $checkQuery = "SELECT * FROM student WHERE USN='$username'";
